...
public class TrainMethodsPrimitive {
    ...
    public void printlnt(int intNumber) {
        System.out.println("я получил на вход число " + intNumber);
    }
    ...
    public void printChar(char charNumber) {
        System.out.println("я получил на вход символ " + charNumber);
    }
